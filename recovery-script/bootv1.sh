#!/bin/bash
##
## Script Patch Vps Linux Remod By DnbizNet
...
function DebianPreseedProcess() {
	if [[ "$setAutoConfig" == "1" ]]; then
		...
		#            https://unix.stackexchange.com/questions/639608/difference-between-debians-linux-image-amd64-and-linux-image-amd64
...
d-i pkgsel/exclude string ufw watchdog systemd-timesyncd bind9-dnsutils bind9-host bind9-libs dnsutils
